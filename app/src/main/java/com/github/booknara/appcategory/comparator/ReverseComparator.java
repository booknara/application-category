 ...
 * @since 1.4
 */
class ReverseComparator extends AbstractPackageComparator implements Serializable {

    private final Comparator<PackageVO> delegate;
     ...
     */
    public ReverseComparator(Comparator<PackageVO> delegate) {
        if (delegate == null) {
    ...
    public int compare(PackageVO package1, PackageVO package2) {
        return delegate.compare(package2, package1); // parameters switched round
    }
